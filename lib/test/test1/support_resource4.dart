    ...
    "element": [
      {
        ...
        "constraint": [
          ...
          },
          {
            ...
            "xpath":
                r"not(exists(for $id in f:contained/*/f:id/@value return $contained[not(parent::*/descendant::f:reference/@value=concat('#', $contained/*/id/@value) or descendant::f:reference[@value='#'])]))",
            "source": "http://hl7.org/fhir/StructureDefinition/DomainResource",
          },
          {
            "key": "dom-4",
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient"},
        ],
      },
      {
        "id": "Patient.id",
      ...
      },
      {
        ...
        "isModifier": false,
        "mapping": [
          {"identity": "argonaut-dq-dstu2", "map": "Patient.extension"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "iso11179", "map": ".patient.administrativeGenderCode"},
          {"identity": "argonaut-dq-dstu2", "map": "Patient.extension"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "rim", "map": "id"},
          {"identity": "cda", "map": ".id"},
          {"identity": "argonaut-dq-dstu2", "map": "Patient.identifier"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.identifier.system"},
        ],
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.identifier.value"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.name"},
        ],
      },
      {
        "id": "Patient.name.id",
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.name.family"},
        ],
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.name.given"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "NA"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.gender"},
        ],
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.birthDate"},
        ],
      },
      {
      ...
      },
      {
        ...
        "mapping": [
          ...
          {"identity": "argonaut-dq-dstu2", "map": "Patient.communication"},
        ],
      },
      {
